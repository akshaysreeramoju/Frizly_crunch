...
export const PRODUCTS: Record<string, Product> = {
  'trial-pack': {
    ...
    images: [
      ...
      '/images/products/trial-pack/2.png',
      '/images/products/trial-pack/3.png',
    ],
  ...
  mango: {
    ...
    category: 'fruit',
    emoji: '🥭',
    img: '/images/products/mango/2.png',
    images: [
      '/images/products/mango/2.png',
      '/images/products/mango/1.png',
      '/images/products/mango/3.png',
    ],
  ...
  guava: {
    ...
    category: 'fruit',
    emoji: '🍐',
    img: '/images/products/guava/1.png',
    images: [
      '/images/products/guava/1.png',
      '/images/products/guava/2.png',
      '/images/products/guava/3.png',
    ],
  ...
  apple: {
    ...
    category: 'fruit',
    emoji: '🍎',
    img: '/images/products/apple/2.jpg',
    images: [
